const CRAFT_DATABASE = {
  "Зброярня": {
    ...
    "Аптека": {
        "COMPONENTS": {
            "Тонізуючий збір лікарських трав": { "Аляскинський женшень ": 3, "Гіркий бур'ян": 3, "Шавлія пустельна": 3, "_output": 1 },
            "Цілющий збір лікарських трав": { "Дикий білоцвіт ": 3, "Гаультерія": 3, "Американський женьшень": 3, "_output": 1 },
            "Заспокійливий збір лікарських трав": { "Кровоцвіт ": 3, "Корінь лопуха": 3, "Ахілея": 3, "_output": 1 },
            "Відновлювальний збір лікарських трав": { "Деревій ": 3, "Молочай": 3, "Мімоза соромлива": 3, "_output": 1 },
            "Флакон спирту": { "Спирт ": 1, "Порожній флакон": 100, "_output": 100 },
        },
        "RECIPES": {
            "Бинт": { "Вовна": 2, "Волокна": 15, "_output": 5 },
            "Стерильний бинт": { "Вовна": 5, "Флакон спирту": 5, "_output": 5 },
        }
    }
};
